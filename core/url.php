...
class Url {
     ...
     * @return an array with each member of an URL
     */
    public static function tokenizeUnbase() {
        $unbased  = Url::tokenize();
     ...
     */
    public static function concordingWith(Service $service) {
        Url::cleanBuffer();
        $uri  = Url::tokenizeUnbase();
        ...
        return Url::accordingParamsWith($service, $rest)
            && Url::postIsValid($service); 
    }
     ...
     * @return true if it was a concordance, false else
     */
    protected static function postIsValid(Service $s) {
        $params = $s->postArgs();
     ...
     * @return true if it was a concordance, false else
     */
    protected static function accordingParamsWith(Service $s, $rest) {
        $params = $s->getArgs();
